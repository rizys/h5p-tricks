...
class h5p {
    ...
    private $modules = [
        ...
        24  => "H5P.Timeline",
        25  => "H5P.TrueFalse",
        26  => "H5P.TwitterUserFeed",
        27  => "H5P.ImageHotspots",
        28  => "H5P.ImageMultipleHotspotQuestion",
        29  => "H5P.ImageJuxtaposition",
        30  => "H5P.Audio",
        31  => "H5P.AudioRecorder",
        32  => "H5P.SpeakTheWords",
        33  => "H5P.Agamotto",
        34  => "H5P.ImageSequencing",
        35  => "H5P.Flashcards",
        36  => "H5P.SpeakTheWordsSet",
        37  => "H5P.ImageSlider",
        38  => "H5P.Essay",
        39  => "H5P.ImagePair",
        40  => "H5P.Dictation",
        41  => "H5P.BranchingScenario",
        42  => "H5P.ThreeImage"
    ];
